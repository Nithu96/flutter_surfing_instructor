...
import 'package:surfing_instructor/models/instructor.dart';

class InstructorDetailsPage extends StatefulWidget {
  final Instructor selectedInstructor;

  InstructorDetailsPage({required this.selectedInstructor});

  @override
  _InstructorDetailsPageState createState() => _InstructorDetailsPageState();
}
        ...
        Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/surfing.jpeg'),
                    fit: BoxFit.cover
                )
            )
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Align(
                                      ...
                                      child: Container(
                                        height: 58.0 +  MediaQuery.of(context).padding.bottom,
                                        width: 100.0,
                                        child: Center(
                                            child: Column(
